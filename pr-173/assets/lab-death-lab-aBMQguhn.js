import{n as O}from"./rolldown-runtime-b3L32Ng1.js";import{Z as T}from"./lab-ai-runner-lab-iEaGhNCd.js";var H=O({});function M(z,C){const r=C.__labGui;if(!r)throw new Error("Lab runner did not initialize lil-gui.");let e="alive",t=null,a;const u={autoKillDelayMs:2e3,simulateOnLoad:!0},b=document.createElement("div");b.className="death-lab";const L=document.createElement("style");L.textContent=`
    .death-lab {
      position: relative;
      min-height: 100%;
      padding: 24px;
