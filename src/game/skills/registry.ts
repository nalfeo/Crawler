    ...
    milestones: [
      {
        ...
        abilityId: 'throwingweapons-toss-base',
      },
      {
        level: 10,
        name: 'Multi-Throw',
        description: '+1 extra projectile with throwing weapons',
        abilityId: 'throwingweapons-salvo',
      },
      {
        level: 15,
        name: 'True Aim',
        description: 'Evolved Sure Throw ability',
        abilityId: 'throwingweapons-toss-evolved',
      },
      {
        level: 20,
        name: 'Bombardier',
        description: 'Evolved Multi-Throw ability',
        abilityId: 'throwingweapons-salvo-evolved',
      },
    ],
    ...
    milestones: [
      {
        ...
        abilityId: 'sportsequipment-swing-base',
      },
      {
        level: 10,
        name: 'Crowd Pleaser',
        description: '+10% damage with sports equipment',
        abilityId: 'sportsequipment-grand-slam',
      },
      {
        level: 15,
        name: 'All-Star',
        description: 'Evolved Game Face ability',
        abilityId: 'sportsequipment-swing-evolved',
      },
      {
        level: 20,
        name: 'MVP',
        description: 'Evolved Crowd Pleaser ability',
        abilityId: 'sportsequipment-grand-slam-evolved',
      },
    ],
