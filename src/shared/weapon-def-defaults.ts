...
export const WEAPON_DEF_DEFAULTS: Readonly<Omit<WeaponDef, RequiredWeaponDefKey>> = Object.freeze({
  range: 0,
  projectileSpeed: 0,
  aoeRadius: 0,
  durationMs: 0,
...
export function createWeaponDef(
  partial: Partial<WeaponDef> & Pick<WeaponDef, RequiredWeaponDefKey>,
): WeaponDef {
  return {
    ...WEAPON_DEF_DEFAULTS,
    ...partial,
