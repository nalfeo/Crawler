...
export const FLOOR5_ACHIEVEMENTS: readonly AchievementDef[] = FLOOR5_ACHIEVEMENT_CATALOG.all;
...
export function createEmptyAchievementFactSnapshot(): AchievementFactSnapshot {
  return {
    ...
    booleanFacts: {
      ...
      floor5WallBreached: false,
      floor5CastleCaptured: false,
      floor5CleanSweep: false,
      floor6RelayBriefed: false,
      floor6FirstWaveCleared: false,
      floor6FirstBuildPlaced: false,
      floor6FirstUpgradeChosen: false,
