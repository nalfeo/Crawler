...
const GENERATED_BRIEF_BY_APPEARANCE_KEY: Readonly<Record<string, string>> = {
  ...
  'myconid-elite-don-agaric': 'myconid-elite-don-agaric-v1',
  'myconid-clubcap': 'myconid-clubcap-v1',
  'toadkin-boss': 'toadkin-boss',
  'toadkin-tongue': 'toadkin-tongue',
  'toadkin-elite-swamp-consigliere': 'toadkin-elite-swamp-consigliere-v1',
  ...
  'batfolk-elite-rave-don': 'batfolk-elite-rave-don-v1',
  ...
  'imp-elite-hellfire-capo': 'imp-elite-hellfire-capo-v1',
