 ...
 */
export function neighborMask(terrain, mapWidth, mapHeight, tx, ty, matchTerrain) {
  let mask = 0;
 ...
 */
export function resolveFrame(visual, terrain, mapWidth, mapHeight, tx, ty, terrainAt) {
 ...
 */
export function getTileVisual(terrain) {
  return TILE_SPRITES[terrain];
}
//# sourceMappingURL=tile-visuals.js.map
