...
const PLAYER_HURT_PULSE_COLOR = 0xff4d4d;
const PLAYER_HURT_PULSE_RADIUS_PX = 10;
const PLAYER_HURT_PULSE_SCALE = 2.4;
const PLAYER_HURT_PULSE_ALPHA = 0.32;
const PLAYER_HURT_PULSE_DURATION_MS = 220;
const PLAYER_HURT_SHAKE_DURATION_MS = 80;
const PLAYER_HURT_SHAKE_INTENSITY = 0.003;
