 ...
 * next agent or session. An unknown id falls through to the normal defaults
 * rather than throwing, so a stale link degrades to the default scenario.
 */
