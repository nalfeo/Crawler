...
function createMeleeSwingLab(canvasHost: HTMLElement, controls: HTMLElement): () => void {
  ...
  root.innerHTML = '<h3>meleeSwing Lab</h3><p>Use weapons-lab for full interaction.</p>';
