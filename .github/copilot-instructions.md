...
- **Apple complexity**: for implementation sessions (merge-intent code changes), declare your 🍎–🍎🍎🍎🍎🍎 estimate before writing code, then score actuals + verdict at handoff and create `docs/knowledge/metrics/apples/YYYY-MM-DD-<slug>.json` — see `docs/agent-os/policies/complexity-policy.md`
