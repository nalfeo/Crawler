...
export function buildWinRateInvestigationClause(baseline) {
  ...
  const summary = below
    ...
    .join(', ');
  return `## Win-rate investigation — floor1→2 chain / Floor 2 below 90% (issue #3240)
