...
const taskBody = [
  ...
  '',
  `When a thread is addressed, reply in that exact thread with \`✅ Addressed in ${headSha}: <one-line note>\` and resolve it. Run the repository-required verification and push one consolidated repair commit.`,
].join('\n');
