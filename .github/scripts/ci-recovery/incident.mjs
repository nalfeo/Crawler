...
const body = [
  ...
  'Manually apply the `ci-repair` label to the resulting PR; issue labels are not automatically propagated, and this label is required for priority admission ahead of ordinary merge-train work.',
].join('\n');
