...
function checkIndexMdNotModified(files) {
  ...
  return `docs/knowledge/handoffs/INDEX.md must not be committed to a PR branch. INDEX.md is auto-generated by docs-update.yml after each merge to main and must stay off PR branches — concurrent agents modifying it is the primary source of merge-queue serialization (see issue #1856). Remove it: \`git rm --cached docs/knowledge/handoffs/INDEX.md\` then re-commit.`;
}
