...
import { SLOT_REGISTRY, DEFAULT_BASE_STATS, STAT_CLAMPS, PRIMARY_STATS, SECONDARY_STATS } from "./data.mjs";
...
const session = await joinSession({
    canvases: [
        createCanvas({
            ...
            description: "Paper doll equipment viewer with 16 slots and live stat display. Open to visualise equipment layout and stat bonuses.",
            inputSchema: {
                type: "object",
                properties: {
                    baseStats: {
