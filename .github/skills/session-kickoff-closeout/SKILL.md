...
8. Keep plans in the session response, and for cloud/coding-agent sessions also in the PR description. Post the plan as an issue comment when explicitly requested. Do not hide plans in repo files unless the human explicitly asks for a file artifact.
