...
| [`review-harness`](review-harness/SKILL.md)                                               | Run apple-scaled post-diff review: tests/CI at 1–2🍎, one review at 3🍎, and two independent reviews at 4–5🍎; canonical policy: [`review-harness-policy.md`](../../docs/agent-os/policies/review-harness-policy.md). |
