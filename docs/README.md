...
| **System docs**           | [`systems/`](systems/)                                                     | Narrative/onboarding view of each subsystem (`01-movement-input` … `08-engine-bridge`).                                                                               |
| **Specs**                 | [`../.specify/specs/README.md`](../.specify/specs/README.md)               | Durable per-system contracts + the missing-spec backlog.                                                                                                              |
| **ADRs**                  | [`knowledge/adr/README.md`](knowledge/adr/README.md)                       | Architecture Decision Records (43) with thematic + by-number indexes and the numbering policy.                                                                        |
...
| **Policies**              | [`agent-os/policies/`](agent-os/policies/)                                 | CI, complexity (apples), lab-gate, memory/handoff, telemetry.                                                                                                         |
...
| -------------------------------------- | ------------------------------------------------------------------------ |
| A single decision affecting 2+ systems | a new [ADR](knowledge/adr/README.md) (`NNNN-slug.md`, next # = **0028**) |
