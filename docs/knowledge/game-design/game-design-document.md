...
**Floor 3 — "The Companion League"** (designed): a monster-taming game-show floor where the player leads auto-battling Companions through movement, equipment, enabled automatic abilities, and party composition instead of fighting. Content bible: [floor3-companion-league.md](floor3-companion-league.md); system spec: [`.specify/specs/floor3-companion-league.md`](../../../.specify/specs/floor3-companion-league.md); architecture: [ADR 0071](../adr/0071-floor3-companion-league.md).
