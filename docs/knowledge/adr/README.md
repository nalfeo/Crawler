...
- [Migrate content generation to Azure AI Foundry](0033-azure-foundry-content-generation.md) — **Superseded by ADR 0072** (Foundry resource had no deployments; standardized on azure-openai).
...
| 0033 | [Migrate Content Generation to Azure AI Foundry](0033-azure-foundry-content-generation.md)                                                         | **Superseded (→ 0072)**  | 2026-06-29 |
...
| 0072 | [Retire Foundry Backend — Standardize Asset Pipeline on Azure OpenAI](0072-retire-foundry-standardize-azure-openai.md)                             | Accepted                 | 2026-07-24 |
