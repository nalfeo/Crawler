...
- Recovered the PR's inherited CI lint failure by applying Node globals to the upstream `preflight-bootstrap.test.mjs`; that test temporarily stubs `console.error`.
