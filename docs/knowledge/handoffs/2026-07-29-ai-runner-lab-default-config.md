...
promoted from the 2026-07-21 AI Sweep winner.
...
- `src/labs/ai-runner-lab/index.ts` — import + three literal replacements + comment
- `tests/unit/ai-runner-default-config-wiring.test.ts` — new test (source-string guard)
