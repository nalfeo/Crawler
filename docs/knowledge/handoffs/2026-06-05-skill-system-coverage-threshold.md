...
- `npx vitest run --project unit --coverage 2>&1 | Select-String -Pattern "skillSystem"`
...
- `npm run verify` currently fails at the format-check step due existing baseline Prettier warnings across many files unrelated to this change.
