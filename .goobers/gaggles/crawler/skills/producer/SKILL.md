...
in the plan artifact and scalar outputs. Do not block merely
...
On success, use these exact output keys: `implementationPlan`, `hardGate`, and
`verdict`. Downstream deterministic stages consume those
