 ...
 */
export declare function perceptualHash(png: Buffer): PerceptualHash;
/**
 ...
 */
export declare function hammingDistance(a: Uint8Array, b: Uint8Array, bitLength: number): number;
/**
 ...
 */
export declare function computeDiversity(
  processedPngs: ReadonlyArray<Buffer>,
