...
cleanup_parallel() {
  ...
  # Follow-up SIGKILL ensures grandchildren (e.g. stub sleep descendants) are
  # dead before this shell exits; SIGTERM delivery is async and a narrow race
  # in CI can let descendants survive the exit otherwise.
