...
const TEST_SCAFFOLD_ALLOWLIST_ENTRIES = [
  ...
  {
    file: 'src/core/systems/achievementRewards.ts',
    name: 'hasPendingAchievementRewardPresentation',
  },
  {
    file: 'src/game/floor2-reward-bundle-resolver.ts',
    name: 'REWARD_BUNDLE_RARITIES',
  },
  {
    file: 'src/game/floor2-reward-bundle-resolver.ts',
    name: 'REWARD_BUNDLE_AFFINITY_PROB',
  },
  {
    file: 'src/game/floor2-reward-bundle-resolver.ts',
    name: 'assertGeneratedRewardInstanceLegal',
  },
  {
    file: 'src/game/floor2-reward-bundle-resolver.ts',
    name: 'alignmentFromRoll',
  },
  {
    file: 'src/game/floor2-reward-bundle-resolver.ts',
    name: 'rollAffinityAlignment',
  },
  {
    file: 'src/game/floor2-reward-bundle-resolver.ts',
    name: 'resolvePlayerBuildAffinity',
  },
  {
    file: 'src/game/floor2-reward-bundle-resolver.ts',
    name: 'rarityEligibleBaseIds',
  },
  {
    file: 'src/game/floor2-reward-bundle-resolver.ts',
    name: 'computeFloor2RewardPoolTierEligibility',
  },
  {
    file: 'src/game/floor2-reward-bundle-resolver.ts',
    name: 'Floor2RewardPoolAuthoringError',
  },
  {
    file: 'src/game/floor2-reward-bundle-resolver.ts',
    name: 'validateFloor2RewardPoolTierEligibility',
  },
  {
    file: 'src/game/floor2-reward-bundle-resolver.ts',
    name: 'rollTierRarity',
  ...
  {
    file: 'src/game/generated-equipment-generator.ts',
    name: 'GenerateEquipmentInstanceRequest',
  },
  {
    file: 'src/game/generated-equipment-generator.ts',
    name: 'getGeneratedEquipmentBaseV1',
  },
  {
    file: 'src/game/systems/achievementSystem.ts',
    name: 'unlockAchievement',
