...
.DESCRIPTION
    ...
    Note: The Azure AI Foundry catalog helper tests (Get-FoundryDeploymentPlan /
    Format-FoundryEnvBlock / Get-FoundrySecretNames) and the setup-azure-env.ps1
    FOUNDRY_* contract tests were removed in ADR 0072 (foundry backend retired).
