...
| Sprite checkin                | `npm run sprites:checkin`                 |
...
| Sprite reprocess welcome room | `npm run sprites:reprocess:welcome-room`  |
...
| Visual review (deterministic) | `npm run review:visual:deterministic`     |
| Visual review (LLM)           | `npm run review:visual:llm`               |
| Visual review (equipment)     | `npm run review:visual:equipment`         |
