...
| Merge train: status      | `npm run train:protection:status`         |
| Merge train: enable      | `npm run train:protection:enable`         |
| Merge train: rollback    | `npm run train:protection:rollback`       |
| Merge train: manage      | `npm run train:protection`                |
| AI hill-climb            | `npm run ai:hill-climb`                   |
| AI weapon sweep          | `npm run ai:weapon-sweep`                 |
| AI winrate sweep         | `npm run ai:winrate-sweep`                |
...
| Sprite gen wiring        | `npm run sprites:generate-wiring`         |
| Sprite reprocess welcome | `npm run sprites:reprocess:welcome-room`  |
| Terrain packs build      | `npm run terrain-packs:build`             |
| Terrain packs validate   | `npm run terrain-packs:validate`          |
| Azure provision          | `npm run setup:azure:provision`           |
| Azure foundry setup      | `npm run setup:azure:foundry`             |
| Azure foundry env        | `npm run setup:azure:foundry:env`         |
| Azure GitHub secrets     | `npm run setup:azure:github`              |
| Check physics defs       | `npm run check:physics-defs-sync`         |
...
| Visual review (determ.)  | `npm run review:visual:deterministic`     |
