...
describe('spawner-arena caging — integration', () => {
  it('player cannot leave the arena disc once the arena is armed', () => {
    ...
    // Open-fence arenas cage with an analytic ring WALL (a sub-tile 1 ft
    // annulus), not blocked tiles — so the registry carries a ring shape and
    // owns zero tiles. This is the smooth-circle boundary, not the old blocky
    // tile ring.
    ...
    // The analytic ring wall is gone: no shapes, no tiles, and the arena's
    // handle is released.
