 ...
 * average over. Seed 14 is the currently re-verified canonical clear (~191s
 * game-time at level 6 with 22 kills, completing all 4 quests under the 300s
 ...
 * clear within the budget). Seed 14 was re-verified with that exact command.
 *
 ...
 */
const WINNING_SEEDS = [14] as const;
