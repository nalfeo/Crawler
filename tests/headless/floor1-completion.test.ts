 ...
 * average over. Seed 4 is the currently re-verified canonical clear (~180s
 * game-time at level 7 with 20 kills, completing all 4 quests under the 300s
 ...
 */
const WINNING_SEEDS = [4] as const;
