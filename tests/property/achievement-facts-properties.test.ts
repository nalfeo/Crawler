...
const factSnapshotArbitrary: fc.Arbitrary<AchievementFactSnapshot> = fc
  .record({
    ...
    booleans: fc.array(fc.boolean(), { minLength: 28, maxLength: 28 }),
  })
  .map((value) => {
    ...
    return {
      ...
      booleanFacts: {
        ...
        floor5WallBreached: value.booleans[14]!,
        floor5CastleCaptured: value.booleans[15]!,
        floor5CleanSweep: value.booleans[16]!,
        floor6RelayBriefed: value.booleans[17]!,
        floor6FirstWaveCleared: value.booleans[18]!,
        floor6FirstBuildPlaced: value.booleans[19]!,
        floor6FirstUpgradeChosen: value.booleans[20]!,
        ...
        floor4Victory: value.booleans[25]!,
        floor4NoOvertime: value.booleans[26]!,
        floor4KeptCompanionCoStar: value.booleans[27]!,
      },
